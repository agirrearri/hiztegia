	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-10 col-lg-10 col-md-offset-1 col-lg-offset-1 text-center">	
				...
				<h1 class="title">ondarruberbetan.com</h1>
				<h2 class="subtitle">Aldaketa batzuk etxen gabiz eta laste osteabe zeuekin.</h2>

				<!-- Short introductory (optional) -->
				<h3 class="tagline">
					Webgune honek Ondarroan erabiltzen diren eta erabili izan diren<br>
                    berba, lokuzio, esaera, metafora eta abar eskaintzen dizkizu.<br><br>
                    Betiko webgunera joateko <a href="http://ondarruberbetan.com/berba">sakatu hamen</a>
				</h3>
...
<script src="<?php echo(base_url());?>assets/js/modernizr.custom.72241.js"></script>
<!-- Custom template scripts -->
<script src="<?php echo(base_url());?>assets/js/magister.js"></script>
</body>
</html>